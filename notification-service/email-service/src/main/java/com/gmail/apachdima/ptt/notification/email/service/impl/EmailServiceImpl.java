package com.gmail.apachdima.ptt.notification.email.service.impl;
...
import com.gmail.apachdima.ptt.common.dto.email.SendEmailContextDTO;
import com.gmail.apachdima.ptt.common.exception.PTTApplicationException;
import com.gmail.apachdima.ptt.notification.email.mapper.EmailMapper;
import com.gmail.apachdima.ptt.notification.email.model.EmailLog;
import com.gmail.apachdima.ptt.notification.email.repository.EmailLogRepository;
import com.gmail.apachdima.ptt.notification.email.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    private void sendPreparedEmail(SendEmailContextDTO context, Locale locale) {
        ...
        try {
            ...
            throw new PTTApplicationException(messageSource.getMessage(Error.EMAIL_SEND_ERROR.getKey(), params, locale));
        }
    }
